...
SELECT TRIM('     H E L L O       ') FROM DUAL; --양쪽 공백제거
...
SELECT MONTHS_BETWEEN(SYSDATE, '2024-06-26') "수강 기간(개월)" 
FROM DUAL;
...
SELECT TO_DATE('510505', 'YYMMDD') FROM DUAL; --2051-05-N B05 00:00:00.000
...
-- TO_NUMBER(문자데이터, [포맷]) : 문자형데이터를 숫자 데이트로 변경
...
SELECT EMP_NAME, JOB_CODE, SALARY, DECODE(JOB_CODE, 'J7', '20%', 'J6', '15%', 'J5', '10%', '5%') 인상률, DECODE(JOB_CODE, 'J7', SALARY*1.2, 'J6', SALARY*1.15, 'J5', SALARY* 1.1, SALARY * 1.05) "인상된 급여" 
FROM EMPLOYEE;
...
-- 비교하고자하는 값 또는 칼럼이 조건식과 같으면 결과값 반환
-- 조건은 범위값가능
