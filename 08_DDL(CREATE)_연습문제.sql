...
INSERT INTO USER_TEST
VALUES(2, 'user02', 'pass02', '890122-1234567', '여', '010-2222-9999', '서울시 강남구 도곡동', 'N');

INSERT INTO USER_TEST
VALUES(3, 'user03', 'pass03', '900122-1234567', '여', '010-3333-9999', '서울시 강남구 청담동', 'Y');

INSERT INTO USER_TEST
VALUES(4, 'user04', 'pass04', '910122-1234567', '남', '010-4444-9999', '서울시 강남구 대치동', 'N');

INSERT INTO USER_TEST
VALUES(5, 'user05', 'pass05', '920122-1234567', '남', '010-5555-9999', '서울시 강남구 삼성동', 'Y');
...
--> 서브퀄리의 조회결과(RESULT SET)의 모양대로 테이블이 생성됨
